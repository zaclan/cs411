...
class Meal:
    ...
    Attributes:
        id (int): The unique identifier of the meal.
    ...
    Raises:
        ValueError: If price is negative or difficulty is invalid.
    """
    id: int
    meal: str
    cuisine: str
...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    ...
    Raises:
        ValueError: If price is not a positive number, difficulty is invalid, or if meal name already exists.
...
def delete_meal(meal_id: int) -> None:
    """Soft deletes a meal in the database by marking it as deleted.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    ...
    Args:
        sort_by (str): Criteria to sort the leaderboard by; 'wins' or 'win_pct'. Defaults to 'wins'.

    Returns:
        list[dict[str, Any]]: A list of meals with their stats, sorted by the specified criteria.

    Raises:
        ValueError: If a invalid sort_by parameter is inputted.
        sqlite3.Error: If any database error occurs.
    """
    query = """
...
def get_meal_by_id(meal_id: int) -> Meal:
    ...
    Returns:
        Meal: The Meal object corresponding to the given meal_ID.
...
def update_meal_stats(meal_id: int, result: str) -> None:
    ...
    Increments the battles count; if the result is 'win', increments the wins count.
    ...
    Raises:
        ValueError: If the meal does not exist, has been deleted, or if result is invalid (not a 'win' or a 'loss').
        sqlite3.Error: If any database error occurs.                                                           
    """
    try:
        with get_db_connection() as conn:
